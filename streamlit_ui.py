...
# Define our own E5 model initialization for the Streamlit app
...
async def main():
    st.title("Agentic RAG For CVE's ")
    st.write("Ask any question about CVE's, the hidden truths of the beauty of this framework lie within.")
